...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DoubleConversion.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhaoyangyang1/DoubleConversion'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhaoyangyang1' => 'zhaoyangyang1@100tal.com' }
  s.source           = { :git => 'https://github.com/zhaoyangyang1/DoubleConversion.git', :tag => s.version.to_s }
